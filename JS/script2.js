...
// Event listener for the refresh button (typically F5 or browser refresh button)
...
// Event listener for when the entire page including all resources (images, stylesheets, etc.) has finished loading
...
document.getElementById("checkout-btn").addEventListener("click", function(event) {
    event.preventDefault(); // Prevent the default behavior (opening the address form)
    localStorage.setItem('openAddressForm', 'true'); // Set flag to open address form
...
var swiper = new Swiper(".product-slider", {
    loop: true,
    spaceBetween: 20,
    autoplay: false, // Set autoplay to false to stop automatic sliding
    centeredSlides: true,
    breakpoints: {
        0: {
            slidesPerView: 1,
